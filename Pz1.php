...
<html lang="en">
	...
	<body>
		...
		<section
			...
			id="call-to-action"
			style="background-image: url(assets/images/Pizza.jpg)"
		>
			<div class="container">
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						<div class="cta-content">
							<br />
							<br />
							<h2>Double Chicken & Cheese Fiesta</h2>
							<h2>950/=</h2>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="contact-form">
							<form action="Pz1" id="contact" method="GET">
								<div class="form-group">
									<p>
										A Combination of Spicy Chicken and Kotchchi Sausage Meat
										with Crunchy Onions and Jalapenos Placed on a Layer of Cream
										Cheese and a Layer of Mozzarella.
									</p>
								</div>
								<br />
								<div class="row">
								...
								<div class="main-button">
									<a href="checkout.php?quantity=1">Add to cart</a>
								</div>
							</form>
						</div>
